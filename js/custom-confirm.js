...
(function () {
    ...
    function getFinalConfig(config) {
        var _defaults = {
            ...
            body: 'Click "Place Order" to place your order',
            btn_yes: 'Place Order',
            btn_no: 'Cancel',
            btn_close: '',
            has_overlay: true
    ...
    function getTemplate() {
        if (! template) {
            ...
            template.innerHTML = '<div class="c2_content"> <header class="c2_header"> <h2 class="c2_title" style="color:black"></h2> <button class="c2_btn-close"></button> </header> <div class="c2_body" style="color:black"> </div><footer class="c2_footer"> <button class="c2_btn-no"></button> <button class="c2_btn-yes"></button> </footer>';
        }
